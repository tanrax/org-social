...
It is heavily inspired by [[https://twtxt.readthedocs.io/en/stable/][twtxt]] and the extensions developed by the [[https://twtxt.dev/][Yarn community]]. It takes the best of these specifications, eliminates complex parts, leverages Org Mode's native features, and keeps the premise that social networking should be simple, accessible to both humans and machines, and manageable with standard text editing tools.
