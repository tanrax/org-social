...
- [[https://github.com/tanrax/org-social.el][org-social.el]] (Emacs)
- [[https://apps.apple.com/us/app/org-social/id6764415116][Org Social]] (iOS)
- [[https://github.com/tanrax/awesome-org-social/][Other clients and libraries]]
...
Now you can read your friends' posts. We recommend the [[https://github.com/tanrax/org-social.el][official Emacs client]] or the [[https://apps.apple.com/us/app/org-social/id6764415116][official iOS app]], or check [[https://github.com/tanrax/awesome-org-social/][other clients]].

** ✍️ You write, reply and read
:PROPERTIES:
:CUSTOM_ID: you-write-reply-and-read
:END:
...
Upload the file to a web server and share the URL with your friends (~https://my-awesome-website.com/social.org~). Don't have your own hosting? [[#where-can-i-host-my-socialorg-file][Check this section]].
...
Now it's your turn to learn how to interact with Org Social's syntax and the community. Check the [[#use-cases][Use cases]] section or install an official client: [[https://github.com/tanrax/org-social.el][org-social.el]] (Emacs) or the [[https://apps.apple.com/us/app/org-social/id6764415116][iOS app]].
...
It is heavily inspired by [[https://twtxt.readthedocs.io/en/stable/][twtxt]], [[https://texudus.com][Texudus]], and the extensions developed by the [[https://twtxt.dev/][Yarn community]]. It takes the best of these specifications, eliminates complex parts, leverages Org Mode's native features, and keeps the premise that social networking should be simple, accessible to both humans and machines, and manageable with standard text editing tools.
...
To consume and read other users' feeds, install an official client: [[https://github.com/tanrax/org-social.el][org-social.el]] for Emacs or the [[https://apps.apple.com/us/app/org-social/id6764415116][iOS app]], or check [[https://github.com/tanrax/awesome-org-social/][other available clients]].
...
Yes. You can use the HTTP header ~Content-Range~ with ~Content-Length~ to paginate the feed. Check the [[https://developer.mozilla.org/en-US/docs/Web/HTTP/Range_requests][HTTP Range Requests]] documentation and [[https://en.andros.dev/blog/4e12225f/why-your-socialorg-files-can-have-millions-of-lines-without-any-performance-issues/][this]] article.

** Where can I host my ~social.org~ file?
:PROPERTIES:
:CUSTOM_ID: where-can-i-host-my-socialorg-file
:END:
...
- Self-hosted: [[https://www.nginx.com/][Nginx]], [[https://httpd.apache.org/][Apache]] or [[https://caddyserver.com/][Caddy]].
...
Yes, [[https://github.com/tanrax/org-social.el][org-social.el]] for Emacs and the [[https://apps.apple.com/us/app/org-social/id6764415116][Org Social iOS app]]. Check [[https://github.com/tanrax/awesome-org-social/][Awesome Org Social]] for more clients and libraries.
...
:PROPERTIES:
:CUSTOM_ID: create-a-mention-only-post
:END:
...
:PROPERTIES:
:CUSTOM_ID: subscribe-to-a-group
:END:
...
*Note:* You will need a [[https://github.com/tanrax/awesome-org-social/][Relay-compatible client]] and access to an [[#org-social-relay][Org Social Relay]] to use this feature.
...
:PROPERTIES:
:CUSTOM_ID: pin-a-post-to-your-profile
:END:
...
:PROPERTIES:
:CUSTOM_ID: react-to-a-post-with-emoji
:END:
...
:PROPERTIES:
:CUSTOM_ID: create-a-multiline-post-with-rich-formatting
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-a-title-to-a-post
:END:
...
*Note:* If you use an official client ([[https://github.com/tanrax/org-social.el][org-social.el]] or the [[https://apps.apple.com/us/app/org-social/id6764415116][iOS app]]), registration happens automatically—no manual step needed.
...
:PROPERTIES:
:CUSTOM_ID: share-an-html-preview-of-a-post
:END:
...
:PROPERTIES:
:CUSTOM_ID: migrate-your-account-to-a-new-url
:END:
...
First, you will need a [[https://github.com/tanrax/awesome-org-social/][Relay-compatible client]].

Then you can set up your own instance of [[https://github.com/tanrax/org-social-relay][Social Org Relay]]. Your node will automatically connect to other active Relay nodes and work with them to remove load from the network and share information. The more Relay nodes there are, the better the experience will be for everyone. It is currently an alpha technology that only allows participation by invitation. When the project is more mature, it will be open to everyone.

Otherwise, you can use a [[file:org-social-relay-list.txt][public Relay node]].
...
- *Org Social (iOS)*: The official iOS client for Org Social. Available on the [[https://apps.apple.com/us/app/org-social/id6764415116][App Store]], it provides a native mobile experience for reading, writing, and interacting with Org Social feeds.
...
- *Org Social Web Reading*: A public HTML timeline viewer. Reads Org Social feeds through the Relay and renders them as a web page, used for example as an embeddable iframe on [[https://org-social.org][org-social.org]].
...
:PROPERTIES:
:CUSTOM_ID: other-cool-things-you-can-do
:END:
...
- [[https://org-social.org/social.org][Org Social official account]]
- [[https://planet-emacs.org-social.org/][Aggregates blogs about Emacs]]
- [[https://org-mode.org-social.org/][Aggregates blogs about Org Mode]]
...
- *[[https://github.com/AdsanTheGreat][AdsanTheGreat]]* - Creator of [[https://github.com/AdsanTheGreat/org-social-rs][org-social-rs]], a CLI/TUI client written in Rust
  - Website: [[https://adsan.dev][adsan.dev]]
  - Org Social Feed: [[https://adsan.dev/social.org][adsan.dev/social.org]]

- *[[https://github.com/cherryramatisdev][cherryramatisdev]]* - Creator of [[https://github.com/cherryramatisdev/org-social.nvim][org-social.nvim]], a Neovim client
  - Website: [[https://cherryramatis.xyz][cherryramatis.xyz]]
  - Org Social Feed: [[https://cherryramatis.xyz/social.org][cherryramatis.xyz/social.org]]

** Community Contributors

These developers contribute to the Org Social ecosystem through integrations, tooling, feedback, and community support:

- *[[https://github.com/johnhamelink][johnhamelink]]*
  - Website: [[https://johnhame.link][johnhame.link]]
  - Org Social Feed: [[https://johnhame.link/social.org][johnhame.link/social.org]]

- *[[https://github.com/dertuxmalwieder][tux0r (dertuxmalwieder)]]*
  - Website: [[https://rosaelefanten.org][rosaelefanten.org]]
  - Org Social Feed: [[https://rosaelefanten.org/social.org][rosaelefanten.org/social.org]]

- *[[https://github.com/TheSolarPrincess][TheSolarPrincess]]*
  - Website: [[https://thesolarprincess.site][thesolarprincess.site]]
  - Org Social Feed: [[https://thesolarprincess.site/social.org][thesolarprincess.site/social.org]]
